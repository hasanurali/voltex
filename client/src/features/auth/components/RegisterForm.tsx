        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-7 p-3">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Input {...register('displayName')} error={errors.displayName?.message} id="display-name" type="text" placeholder="e.g. Jhon Doe" className={`py-3 px-4 bg-neutral-50 focus:bg-transparent ${!errors.displayName && 'focus:border-primary-800'} placeholder:text-neutral-400 focus:placeholder:text-neutral-500`} />
                </div>

                {/* Username */}
                <div className="flex flex-col gap-1">
                    <label htmlFor="username" className="text-primary-700 font-label text-[15px] tracking-[0.2px]">Username</label>
                    <Input {...register('username')} error={errors.username?.message} id="username" type="text" placeholder="e.g. jhondoe9" className={`py-3 px-4 bg-neutral-50 focus:bg-transparent ${!errors.username && 'focus:border-primary-800'} placeholder:text-neutral-400 focus:placeholder:text-neutral-500`} />
                </div>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Input {...register('confirmPassword')} error={errors.confirmPassword?.message} id="confirm-password" type="password" showPasswordToggle={true} placeholder="••••••••" className={`py-3 px-3 bg-neutral-50 focus:bg-transparent ${!errors.confirmPassword && 'focus:border-primary-800'} placeholder:text-neutral-400 focus:placeholder:text-neutral-500`} />
                </div>
